...
export var petrovich = function (person, gcase) {
  var result = {}
  // gender detection
  ...
  for (var i = 0; i < predef.genders.length; i++) {
    ...
    for (var j = 0; j < predef.nametypes.length; j++) {
      ...
      for (var k = 0; k < predef.cases.length; k++) {
        ...
        petrovich[gender][nametype][gcase] = (function (
          gender,
          nametype,
          gcase
        ) {
